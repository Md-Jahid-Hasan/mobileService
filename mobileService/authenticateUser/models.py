...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    primary_number = models.OneToOneField('subscription.Number', on_delete=models.SET_NULL,
                             related_name='primay_number', null=True)
    subs_plan = models.ForeignKey('subscription.Plan', on_delete=models.SET_NULL, null=True)
